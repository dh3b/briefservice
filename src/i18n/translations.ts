const base = {
  ...
  chat: { title: "", placeholder: "", send: "", greeting: "", serviceContext: "", namePrompt: "", namePlaceholder: "", nameSubmit: "" },
  admin: {
    ...
    renameChat: "", chatTitle: "", imageUrl: "", uploadImage: "", priceRange: "", category: "",
...
const pl: TranslationShape = {
  ...
  chat: { title: "Czat na żywo", placeholder: "Napisz wiadomość...", send: "Wyślij", greeting: "Cześć! Jak możemy Ci pomóc?", serviceContext: "Pytanie dotyczy usługi:", namePrompt: "Podaj swoje imię, aby rozpocząć czat:", namePlaceholder: "Twoje imię...", nameSubmit: "Rozpocznij czat" },
  admin: {
    ...
    renameChat: "Zmień nazwę", chatTitle: "Tytuł czatu", imageUrl: "URL obrazu", uploadImage: "Prześlij obraz",
    priceRange: "Zakres cenowy", category: "Kategoria", titleField: "Tytuł", descriptionField: "Opis",
    languageTab: "Język", cancel: "Anuluj", save: "Zapisz", noServices: "Brak usług", noCategories: "Brak kategorii",
  },
...
const en: TranslationShape = {
  ...
  chat: { title: "Live Chat", placeholder: "Type a message...", send: "Send", greeting: "Hello! How can we help you?", serviceContext: "Question about service:", namePrompt: "Enter your name to start chatting:", namePlaceholder: "Your name...", nameSubmit: "Start Chat" },
  admin: {
    ...
    renameChat: "Rename", chatTitle: "Chat Title", imageUrl: "Image URL", uploadImage: "Upload Image",
    priceRange: "Price Range", category: "Category", titleField: "Title", descriptionField: "Description",
    languageTab: "Language", cancel: "Cancel", save: "Save", noServices: "No services found", noCategories: "No categories found",
  },
...
const de: TranslationShape = {
  ...
  chat: { title: "Live-Chat", placeholder: "Nachricht eingeben...", send: "Senden", greeting: "Hallo! Wie können wir Ihnen helfen?", serviceContext: "Frage zum Service:", namePrompt: "Geben Sie Ihren Namen ein:", namePlaceholder: "Ihr Name...", nameSubmit: "Chat starten" },
  admin: { login: "Anmelden", username: "Benutzername", password: "Passwort", signIn: "Einloggen", dashboard: "Admin-Dashboard", chats: "Chats", servicesManage: "Leistungen verwalten", noChats: "Keine aktiven Chats", deleteChat: "Chat löschen", addService: "Leistung hinzufügen", editService: "Bearbeiten", deleteService: "Löschen", logout: "Abmelden", addCategory: "Kategorie hinzufügen", editCategory: "Kategorie bearbeiten", deleteCategory: "Löschen", categories: "Kategorien", saveService: "Leistung speichern", saveCategory: "Kategorie speichern", renameChat: "Umbenennen", chatTitle: "Chat-Titel", imageUrl: "Bild-URL", uploadImage: "Bild hochladen", priceRange: "Preisbereich", category: "Kategorie", titleField: "Titel", descriptionField: "Beschreibung", languageTab: "Sprache", cancel: "Abbrechen", save: "Speichern", noServices: "Keine Leistungen", noCategories: "Keine Kategorien" },
...
const es: TranslationShape = {
  ...
  chat: { title: "Chat en vivo", placeholder: "Escribir mensaje...", send: "Enviar", greeting: "¡Hola! ¿Cómo podemos ayudarle?", serviceContext: "Pregunta sobre el servicio:", namePrompt: "Ingrese su nombre para comenzar:", namePlaceholder: "Su nombre...", nameSubmit: "Iniciar chat" },
  admin: { login: "Iniciar sesión", username: "Usuario", password: "Contraseña", signIn: "Entrar", dashboard: "Panel de control", chats: "Chats", servicesManage: "Gestionar servicios", noChats: "Sin chats activos", deleteChat: "Eliminar", addService: "Añadir servicio", editService: "Editar", deleteService: "Eliminar", logout: "Cerrar sesión", addCategory: "Añadir categoría", editCategory: "Editar categoría", deleteCategory: "Eliminar", categories: "Categorías", saveService: "Guardar", saveCategory: "Guardar", renameChat: "Renombrar", chatTitle: "Título del chat", imageUrl: "URL de imagen", uploadImage: "Subir imagen", priceRange: "Rango de precios", category: "Categoría", titleField: "Título", descriptionField: "Descripción", languageTab: "Idioma", cancel: "Cancelar", save: "Guardar", noServices: "Sin servicios", noCategories: "Sin categorías" },
...
const it: TranslationShape = {
  ...
  chat: { title: "Chat dal vivo", placeholder: "Scrivi un messaggio...", send: "Invia", greeting: "Ciao! Come possiamo aiutarti?", serviceContext: "Domanda sul servizio:", namePrompt: "Inserisci il tuo nome per iniziare:", namePlaceholder: "Il tuo nome...", nameSubmit: "Inizia chat" },
  admin: { login: "Accesso", username: "Utente", password: "Password", signIn: "Accedi", dashboard: "Dashboard", chats: "Chat", servicesManage: "Gestisci servizi", noChats: "Nessuna chat attiva", deleteChat: "Elimina", addService: "Aggiungi servizio", editService: "Modifica", deleteService: "Elimina", logout: "Esci", addCategory: "Aggiungi categoria", editCategory: "Modifica categoria", deleteCategory: "Elimina", categories: "Categorie", saveService: "Salva", saveCategory: "Salva", renameChat: "Rinomina", chatTitle: "Titolo chat", imageUrl: "URL immagine", uploadImage: "Carica immagine", priceRange: "Fascia di prezzo", category: "Categoria", titleField: "Titolo", descriptionField: "Descrizione", languageTab: "Lingua", cancel: "Annulla", save: "Salva", noServices: "Nessun servizio", noCategories: "Nessuna categoria" },
...
const pt: TranslationShape = {
  ...
  chat: { title: "Chat ao vivo", placeholder: "Escrever mensagem...", send: "Enviar", greeting: "Olá! Como podemos ajudar?", serviceContext: "Pergunta sobre o serviço:", namePrompt: "Insira o seu nome para começar:", namePlaceholder: "O seu nome...", nameSubmit: "Iniciar chat" },
  admin: { login: "Entrar", username: "Utilizador", password: "Senha", signIn: "Entrar", dashboard: "Painel de controlo", chats: "Chats", servicesManage: "Gerir serviços", noChats: "Sem chats ativos", deleteChat: "Eliminar", addService: "Adicionar serviço", editService: "Editar", deleteService: "Eliminar", logout: "Sair", addCategory: "Adicionar categoria", editCategory: "Editar categoria", deleteCategory: "Eliminar", categories: "Categorias", saveService: "Guardar", saveCategory: "Guardar", renameChat: "Renomear", chatTitle: "Título do chat", imageUrl: "URL da imagem", uploadImage: "Carregar imagem", priceRange: "Faixa de preço", category: "Categoria", titleField: "Título", descriptionField: "Descrição", languageTab: "Idioma", cancel: "Cancelar", save: "Guardar", noServices: "Sem serviços", noCategories: "Sem categorias" },
...
const cs: TranslationShape = {
  ...
  chat: { title: "Živý chat", placeholder: "Napište zprávu...", send: "Odeslat", greeting: "Ahoj! Jak vám můžeme pomoci?", serviceContext: "Dotaz ke službě:", namePrompt: "Zadejte své jméno pro zahájení:", namePlaceholder: "Vaše jméno...", nameSubmit: "Zahájit chat" },
  admin: { login: "Přihlášení", username: "Uživatel", password: "Heslo", signIn: "Přihlásit", dashboard: "Administrace", chats: "Chaty", servicesManage: "Správa služeb", noChats: "Žádné aktivní chaty", deleteChat: "Smazat", addService: "Přidat službu", editService: "Upravit", deleteService: "Smazat", logout: "Odhlásit", addCategory: "Přidat kategorii", editCategory: "Upravit kategorii", deleteCategory: "Smazat", categories: "Kategorie", saveService: "Uložit", saveCategory: "Uložit", renameChat: "Přejmenovat", chatTitle: "Název chatu", imageUrl: "URL obrázku", uploadImage: "Nahrát obrázek", priceRange: "Cenové rozpětí", category: "Kategorie", titleField: "Název", descriptionField: "Popis", languageTab: "Jazyk", cancel: "Zrušit", save: "Uložit", noServices: "Žádné služby", noCategories: "Žádné kategorie" },
...
const ro: TranslationShape = {
  ...
  chat: { title: "Chat live", placeholder: "Scrieți un mesaj...", send: "Trimite", greeting: "Bună! Cum vă putem ajuta?", serviceContext: "Întrebare despre serviciu:", namePrompt: "Introduceți numele pentru a începe:", namePlaceholder: "Numele dvs...", nameSubmit: "Începe chat" },
  admin: { login: "Autentificare", username: "Utilizator", password: "Parolă", signIn: "Conectare", dashboard: "Panou de control", chats: "Chaturi", servicesManage: "Gestionare servicii", noChats: "Niciun chat activ", deleteChat: "Șterge", addService: "Adaugă serviciu", editService: "Editează", deleteService: "Șterge", logout: "Deconectare", addCategory: "Adaugă categorie", editCategory: "Editează categoria", deleteCategory: "Șterge", categories: "Categorii", saveService: "Salvează", saveCategory: "Salvează", renameChat: "Redenumește", chatTitle: "Titlul chatului", imageUrl: "URL imagine", uploadImage: "Încarcă imagine", priceRange: "Interval preț", category: "Categorie", titleField: "Titlu", descriptionField: "Descriere", languageTab: "Limbă", cancel: "Anulează", save: "Salvează", noServices: "Niciun serviciu", noCategories: "Nicio categorie" },
...
const hu: TranslationShape = {
  ...
  chat: { title: "Élő chat", placeholder: "Írjon üzenetet...", send: "Küldés", greeting: "Szia! Miben segíthetünk?", serviceContext: "Kérdés a szolgáltatásról:", namePrompt: "Adja meg nevét a kezdéshez:", namePlaceholder: "Az Ön neve...", nameSubmit: "Chat indítása" },
  admin: { login: "Bejelentkezés", username: "Felhasználó", password: "Jelszó", signIn: "Belépés", dashboard: "Vezérlőpult", chats: "Csevegések", servicesManage: "Szolgáltatások kezelése", noChats: "Nincs aktív csevegés", deleteChat: "Törlés", addService: "Szolgáltatás hozzáadása", editService: "Szerkesztés", deleteService: "Törlés", logout: "Kijelentkezés", addCategory: "Kategória hozzáadása", editCategory: "Kategória szerkesztése", deleteCategory: "Törlés", categories: "Kategóriák", saveService: "Mentés", saveCategory: "Mentés", renameChat: "Átnevezés", chatTitle: "Chat címe", imageUrl: "Kép URL", uploadImage: "Kép feltöltése", priceRange: "Árkategória", category: "Kategória", titleField: "Cím", descriptionField: "Leírás", languageTab: "Nyelv", cancel: "Mégse", save: "Mentés", noServices: "Nincs szolgáltatás", noCategories: "Nincs kategória" },
...
const sv: TranslationShape = {
  ...
  chat: { title: "Livechatt", placeholder: "Skriv ett meddelande...", send: "Skicka", greeting: "Hej! Hur kan vi hjälpa dig?", serviceContext: "Fråga om tjänst:", namePrompt: "Ange ditt namn för att börja:", namePlaceholder: "Ditt namn...", nameSubmit: "Starta chatt" },
  admin: { login: "Logga in", username: "Användarnamn", password: "Lösenord", signIn: "Logga in", dashboard: "Kontrollpanel", chats: "Chattar", servicesManage: "Hantera tjänster", noChats: "Inga aktiva chattar", deleteChat: "Ta bort", addService: "Lägg till tjänst", editService: "Redigera", deleteService: "Ta bort", logout: "Logga ut", addCategory: "Lägg till kategori", editCategory: "Redigera kategori", deleteCategory: "Ta bort", categories: "Kategorier", saveService: "Spara", saveCategory: "Spara", renameChat: "Byt namn", chatTitle: "Chattitel", imageUrl: "Bild-URL", uploadImage: "Ladda upp bild", priceRange: "Prisklass", category: "Kategori", titleField: "Titel", descriptionField: "Beskrivning", languageTab: "Språk", cancel: "Avbryt", save: "Spara", noServices: "Inga tjänster", noCategories: "Inga kategorier" },
