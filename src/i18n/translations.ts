...
const ro: TranslationShape = {
  ...
  hero: { title: "DOCUMENTE GERMANE ALE VEHICULULUI • ÎNMATRICULARE ÎN GERMANIA • MODIFICĂRI STRUCTURALE (MTMA 2500 / 3500)", titleAccent: "Ne ocupăm de gestionarea completă a procedurilor administrative legate de vehiculele înmatriculate în Germania.", subtitle: "Suntem specializați în obținerea duplicatelor documentelor germane de vehicul pierdute (Zulassungsbescheinigung Teil I și Teil II), esențiale pentru reînmatricularea unui vehicul importat din Germania în alte state ale Uniunii Europene. Gestionăm, de asemenea, proceduri legate de înmatricularea vehiculelor în Germania, modificări structurale și legalizarea modificărilor tehnice ale vehiculelor conform reglementărilor în vigoare. Suntem specializați și în cazuri dificile și nestandardizate, în care procedurile administrative standard se dovedesc insuficiente. Deservim clienți din întreaga Uniune Europeană, gestionând cazuri care necesită contact direct cu autoritățile germane de înmatriculare și instituțiile tehnice.", cta: "Vezi servicii", chatCta: "Vorbește cu noi" },
  ...
  footer: { rights: "Toate drepturile rezervate.", description: "Oferta se referă la obținerea de noi documente de înmatriculare Brief german (în caz de pierdere, deteriorare sau furt)!", cookieNotice: { before: "Acest site folosește cookie-uri. Mai multe informații în ", linkText: "Politica de Confidențialitate", after: "." } },
...
const lt: TranslationShape = {
  ...
  hero: { title: "VOKIŠKI TRANSPORTO PRIEMONĖS DOKUMENTAI • REGISTRACIJA VOKIETIJOJE • KONSTRUKCINIAI PAKEITIMAI (DLM 2500 / 3500)", titleAccent: "Mes atliekame visapusišką administracinių procedūrų, susijusių su Vokietijoje registruotomis transporto priemonėmis, tvarkymą.", subtitle: "Specializuojamės gauti pamestų vokiškų transporto priemonės dokumentų (Zulassungsbescheinigung Teil I ir Teil II) dublikatus, kurie yra būtini norint perregistruoti iš Vokietijos importuotą transporto priemonę kitose Europos Sąjungos valstybėse. Taip pat atliekame procedūras, susijusias su transporto priemonių registracija Vokietijoje, konstrukciniais pakeitimais ir techninių transporto priemonių pakeitimų legalizavimu pagal galiojančius teisės aktus. Specializuojamės ir sudėtingose bei nestandartinėse bylose, kuriose standartinės administracinės procedūros yra nepakankamos. Aptarnaujame klientus iš visos Europos Sąjungos, tvarkydami bylas, reikalaujančias tiesioginio kontakto su Vokietijos registracijos institucijomis ir techninėmis įstaigomis.", cta: "Peržiūrėti paslaugas", chatCta: "Rašykite mums" },
  ...
  footer: { rights: "Visos teisės saugomos.", description: "Pasiūlymas taikomas naujų vokiškų Brief registracijos dokumentų gavimui (pametimo, praradimo ar vagystės atveju)!", cookieNotice: { before: "Ši svetainė naudoja slapukus. Daugiau informacijos ", linkText: "Privatumo politikoje", after: "." } },
