...
const sv: TranslationShape = {
  ...
  admin: { login: "Logga in", username: "Användarnamn", password: "Lösenord", signIn: "Logga in", dashboard: "Kontrollpanel", chats: "Chattar", servicesManage: "Hantera tjänster", noChats: "Inga aktiva chattar", deleteChat: "Ta bort", addService: "Lägg till tjänst", editService: "Redigera", deleteService: "Ta bort", logout: "Logga ut", addCategory: "Lägg till kategori", editCategory: "Redigera kategori", deleteCategory: "Ta bort", categories: "Kategorier", saveService: "Spara", saveCategory: "Spara", renameChat: "Byt namn", chatTitle: "Chattitel", imageUrl: "Bild-URL", uploadImage: "Ladda upp bild", priceRange: "Prisklass", category: "Kategori", titleField: "Titel", descriptionField: "Beskrivning", languageTab: "Språk", cancel: "Avbryt", save: "Spara", noServices: "Inga tjänster", noCategories: "Inga kategorier", statistics: "Statistik", visits: "Webbplatsbesök", chatsByService: "Chattar per tjänst", timeRange: "Tidsperiod", week: "Vecka", month: "Månad", halfYear: "Halvår", year: "År", filterAll: "Alla", noData: "Ingen data" },
